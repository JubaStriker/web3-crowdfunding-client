...
const Navbar = () => {
    ...
    return (
        <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6 w-full max-h-[180px] ">
            ...
            <div className="sm:flex hidden flex-row justify-end gap-4 h-[15px]">
                <CustomButton
                    btnType="button"
